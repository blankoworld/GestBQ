      ...
      * Structure du compte mémorisé de la sélection du client
       01 LAncienCompte.
            10 CodeBanque    SQL CHAR(5).
      ...
      * Affichage des données du client (entête)
       01 M-Donnees-Client.
      ...
      * Affichage des données du client (dans l'entête)     
